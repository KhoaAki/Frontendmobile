...
export default function TeacherDetailsScreen({ navigation }) {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.teacherName}>Teacher No.#</Text>

      <View style={styles.detailsContainer}>
        <View style={styles.detailRow}>
          <Text style={styles.detailLabel}>Mã số hồ sơ</Text>
          <Text style={styles.detailValue}>Mã số hồ sơ</Text>
        </View>
        <View style={styles.detailRow}>
        ...
        <View style={styles.detailRow}>
          <Text style={styles.detailLabel}>Môn học dạy</Text>
          <Text style={styles.detailValue}>Mã số hồ sơ</Text>
        </View>
      </View>
